...
| Presets | `olo-definition/olo-configuration/default/*.json` — chat profiles and task-queue workflows (data, not a Gradle module) |
...
|----------------|---------|
| `workflowDefinitions.scanFolder` | `../../olo-definition/olo-configuration/default` |
