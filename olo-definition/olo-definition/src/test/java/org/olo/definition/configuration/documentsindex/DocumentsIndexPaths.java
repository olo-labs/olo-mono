...
final class DocumentsIndexPaths {

    private static final String RELATIVE = "olo-configuration/documents-index";
    private static final String PROPERTY = "olo.documentsIndex.configuration.dir";

    private DocumentsIndexPaths() {
    }
