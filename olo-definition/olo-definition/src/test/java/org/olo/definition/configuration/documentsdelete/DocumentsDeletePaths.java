...
final class DocumentsDeletePaths {

    private static final String RELATIVE = "olo-configuration/documents-delete";
    private static final String PROPERTY = "olo.documentsDelete.configuration.dir";

    private DocumentsDeletePaths() {
    }
