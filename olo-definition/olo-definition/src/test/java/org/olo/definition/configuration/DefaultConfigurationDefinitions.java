    ...
    static WorkflowDefinition ragChat() {
        ...
        return build(WorkflowBuilder.create("RAG Chat")
                ...
                .addNode(NodeDefinition.builder()
                        ...
                        .addPort(WorkflowBuilder.capabilitiesPort(org.olo.definition.port.PortDirection.INPUT))
                        .addPort(WorkflowBuilder.agentPlugPort(org.olo.definition.port.PortDirection.INPUT))
                ...
                .nodeCanvasLayout(WorkflowConversationPluginSupport.CONVERSATION_LOAD_NODE_ID, 1)
                .nodeCanvasLayout(ragQueryNodeId, 2)
                .nodeCanvasLayout("agent", 3)
                .nodeCanvasLayout(WorkflowConversationPluginSupport.CONVERSATION_STORE_NODE_ID, 4)
