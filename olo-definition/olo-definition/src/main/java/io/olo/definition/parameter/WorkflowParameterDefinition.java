package io.olo.definition.parameter;
 ...
 * {@code parameters} on {@link io.olo.definition.workflow.WorkflowDefinition}. Not the same as
 * workflow {@linkplain io.olo.definition.state.StateFieldDefinition state} or node {@code configuration}.
 */
