 ...
 * Pair with {@link io.olo.definition.execution.ExecutionKind} for runtime scheduling semantics.

 * Child workflows are referenced via {@link io.olo.definition.workflow.WorkflowReferenceDefinition}
...
public enum NodeType {
     ...
     * Fan-out parallel section. Requires {@link NodeDefinition#getJoin()} ({@link io.olo.definition.parallel.JoinDefinition}).
