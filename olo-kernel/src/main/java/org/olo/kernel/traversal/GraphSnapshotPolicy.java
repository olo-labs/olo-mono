 ...
 */
final class GraphSnapshotPolicy {
    ...
    static String maybeEmbedGraphJson(String queue, WorkflowInput input, WorkflowDefinition graph) {
    ...
    static WorkflowDefinition resolveGraph(String queue, WorkflowInput input, String graphJson) {
